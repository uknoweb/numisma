...
async function main() {
  ...
  // Deploy del contrato
  const PoolCentinelaRegeneracion = await ethers.getContractFactory("PoolCentinelaRegeneracion");
  ...
  console.log("   WLD/USDT Price:", (await pool.getWLDPrice()) / BigInt(1_000_000), "USD");
