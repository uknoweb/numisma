      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-800 bg-gray-900">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white relative"
        ...
        <button 
          onClick={onClose} 
          className="text-white hover:text-[--color-gold]" 
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 bg-black">
        ...
        <div>
          <div className="text-sm text-gray-400 mb-3">
            Monto ({balanceSymbol}) - Disponible: {formatNumber(availableBalance, 2)}
          </div>
          <input
            type="number"
            value={amount}
